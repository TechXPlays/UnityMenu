...
public class TechXMenu : MonoBehaviour {
    ...
    public static string mainFloatCredit = "SinfulHax";
    public static string argb = "00cfffff";
    public static int txtSize = 50;
    public static string menuCredits1 = "TechX";
    public static string menuCredits2 = "AndnixSH";
    ...
    public static void MyGUI()
    {
        ...
        GUI.Label(new Rect(X - (X - xCredit), Y - (Y - yCredit), 10, 10), "<b><color=#" + argb + ">TechX Menu Hax</color></b>", styled);
        ...
        // Draw image
        GUI.DrawTexture(imageRect, Image, scale, true, 0f, new Color32(255, 255, 255, 222), 26f, 12f);
    ...
    public static void MyMenu()
    {
        ...
        if (toggle1)
        {
            ...
            if (GUI.Button(BtnRect(1, false), hack1 + ": ON", OnStyle))
            {
                toggle1 = false;
        ...
        /// Clicker Button
        // Open URL
        if (GUI.Button(BtnRect(8, false), "Visit SinfulAndroid!", BtnStyle))
        {
             Application.OpenURL("https://sinfulandroid.net/");
    ...
    public static void imageHex()
    {
        ...
        //and paste it here
        /* C:\Users\TechX\Pictures\Attackrangeicon.png (8/11/2018 10:58:48 PM)
       StartOffset: 00000000, EndOffset: 00001611, Length: 00001612 */

        byte[] rawData = {
    0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0x00, 0x00, 0x00, 0x0D,
    0x49, 0x48, 0x44, 0x52, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00, 0x00, 0x43,
    0x08, 0x04, 0x00, 0x00, 0x00, 0x6D, 0xC3, 0x70, 0xF8, 0x00, 0x00, 0x00,
    ...
    ,
